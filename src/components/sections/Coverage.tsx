...
export default function Coverage() {
  return (
    <section id="cobertura" className="py-20 bg-[#F0F4F8] relative overflow-hidden">
      {/* Brillo sutil de fondo */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#0066FF] rounded-full blur-[160px] opacity-[0.04]"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="relative">
            {/* Imagen de mapa estilizado */}
            <div className="mb-6 rounded-2xl overflow-hidden shadow-lg">

              <div className="bg-gradient-to-r from-[#0066FF] to-[#00D9FF] py-10 px-6 text-center">
                <p className="text-white text-xl font-semibold ">📍 Sabana Norte, Cundinamarca — Colombia</p>
              </div>
            </div>
              ...
              <div className="p-10">
                ...
                <div className="space-y-8 mb-5">
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h4 className="text-base font-bold text-[#0A1929]">Respuesta en menos de 24h</h4>
                ...
                <div className="pt-8 border-t border-gray-100">
                  ...
                  >
                    <span className="text-sm font-bold text-gray-600 group-hover/link:text-white transition-colors">
                      Consultar otra ubicación
                    </span>
                    <div className="w-8 h-8 rounded-xl bg-white flex items-center justify-center shadow-sm group-hover/link:translate-x-1 transition-transform">
